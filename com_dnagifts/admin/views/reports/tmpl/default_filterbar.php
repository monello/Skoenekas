...
?>
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			<select title="<?php echo JText::_('COM_DNAGIFTS_FILTER_BY_TESTSTATUS'); ?>" name="filter_published" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('JOPTION_SELECT_PUBLISHED');?></option>
				<?php echo JHtml::_('select.options', JHtml::_('jgrid.publishedOptions'), 'value', 'text', $this->state->get('filter.state'), true);?>
			</select>
			
			<select title="<?php echo JText::_('COM_DNAGIFTS_FILTER_BY_TESTLANGUAGE'); ?>" name="filter_language" class="inputbox" onchange="this.form.submit()">
