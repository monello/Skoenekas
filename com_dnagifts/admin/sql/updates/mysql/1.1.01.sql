ALTER TABLE `#__dnagifts_pretest_info` ADD `church_mapped` VARCHAR( 50 ) NULL COMMENT 'Cleaned Church Value',
ADD `church_done` TINYINT( 1 ) NOT NULL COMMENT 'Church mapping updated',
ADD `city_mapped` VARCHAR( 50 ) NULL COMMENT 'Cleaned City Value',
ADD `city_done` TINYINT( 1 ) NOT NULL COMMENT 'City mapping updated',
ADD `pastor_mapped` VARCHAR( 50 ) NULL COMMENT 'Cleaned Pastor/Reverend Value',
