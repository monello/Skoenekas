 ...
 * DnaGifts Model
 */
class DnaGiftsModelGifts extends JModelList
{
	/**
	* Constructor.
	*
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array('id', 'code', 'name', 'description', 'color_hex', 'ordering', 'language', 'created', 'published');
		}
	...
	*/
	protected function getListQuery()
	{
		...
		$query->select('id, published, code, name, description, color_hex, ordering, language, created');
		$query->from($db->quoteName('#__dnagifts_lst_gift'));
