 ...
 * DnaGifts Model
 */
class DnaGiftsModelTests extends JModelList
{
	/**
	* Constructor.
	*
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array(
				'id', 'test_name', 'test_description', 'ordering', 'hits', 'complete', 'language', 'created', 'published'
			);
		}
	...
	*/
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('test_name', 'asc');
	}
