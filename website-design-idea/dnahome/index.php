			...
			<div class="row-fluid">
				<nav class="span8 offset2">
				        <ul class="nav nav-pills">
							...
							<li><a id="booknav" href="#">The Book</a></li>
							<li><a id="buynav" href="#">Purchase</a></li>
							<li><a id="testnav" href="#">Free Test</a></li>
							<li><a id="giftsnav" href="#">DNA Gifts</a></li>
							<li><a id="eventsnav" href="#">Events</a></li>
							<li><a id="seminarnav" href="#">Seminars</a></li>
						</ul>
				</nav>
			</div>
			<div class="row-fluid">
		...
		<div class="row-fluid">
			<div class="span6 offset3">
				<div id="dnaCallToActionContainer">
					<div id="dnaDoTheTest">
						<span class="dnaCallToAction"><a href="#">Do the free Test</a></span><br/>
						<span class="dnaCallToActionSub"><a href="#">Discover your Natural Abilities</a></span>
					</div>
					<div id="dnaDivider">|</div>
					<div id="dnaPurchaseBook">
						<span class="dnaCallToAction"><a href="#">Purchase the Book</a></span><br/>
						<span class="dnaCallToActionSub"><a href="#">Keep growing your Natural Abilities</a></span>
					</div>
				</div>
			</div>
		</div>
